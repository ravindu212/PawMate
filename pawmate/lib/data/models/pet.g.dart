...
void _petSerialize(
  ...
  writer.writeString(offsets[4], object.profilePhotoPath);
...
Pet _petDeserialize(
  ...
  object.gender = _PetgenderValueEnumMap[reader.readByteOrNull(offsets[2])] ??
      PetGender.male;
  object.id = id;
  object.name = reader.readString(offsets[3]);
  object.profilePhotoPath = reader.readStringOrNull(offsets[4]);
...
extension PetQueryFilter on QueryBuilder<Pet, Pet, QFilterCondition> {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> genderEqualTo(PetGender value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'gender',
        value: value,
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'profilePhotoPath',
        value: '',
  ...
  QueryBuilder<Pet, Pet, QAfterFilterCondition> profilePhotoPathIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'profilePhotoPath',
        value: '',
...
extension PetQuerySortBy on QueryBuilder<Pet, Pet, QSortBy> {
  ...
  QueryBuilder<Pet, Pet, QAfterSortBy> sortByProfilePhotoPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profilePhotoPath', Sort.asc);
    });
  }

  QueryBuilder<Pet, Pet, QAfterSortBy> sortByProfilePhotoPathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PetQuerySortThenBy on QueryBuilder<Pet, Pet, QSortThenBy> {
  ...
  QueryBuilder<Pet, Pet, QAfterSortBy> thenByProfilePhotoPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profilePhotoPath', Sort.asc);
    });
  }

  QueryBuilder<Pet, Pet, QAfterSortBy> thenByProfilePhotoPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profilePhotoPath', Sort.desc);
    });
  }
...
extension PetQueryWhereDistinct on QueryBuilder<Pet, Pet, QDistinct> {
  ...
  QueryBuilder<Pet, Pet, QDistinct> distinctByProfilePhotoPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PetQueryProperty on QueryBuilder<Pet, Pet, QQueryProperty> {
  ...
  QueryBuilder<Pet, PetGender, QQueryOperations> genderProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pet, String?, QQueryOperations> profilePhotoPathProperty() {
    return QueryBuilder.apply(this, (query) {
